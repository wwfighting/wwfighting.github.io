...
看下面这个列子实现的效果[!toolbar伸缩](http://img1.tuicool.com/m6bqA3.gif!web)
其布局文件应该这么写：
...
app:borderWidth="0dp" (5.x系统需要设置，不然没阴影效果，而且layout_margin="@dimen/fab_margin"
...
values-v21
 ...
 两个不错的Github上有关FloatingActionButton的开源项目：
 1) https://github.com/futuresimple/android-floating-action-button;
 2) https://github.com/makovkastar/FloatingActionButton

其他讲解FloatingActionButton不错的博客https://www.baidu.com/link?url=jQON2_dVG_GOfqtz4prN-DSrntZ317xxn0ZhhMNB6XuNOdPeCaEDUbSkC1-T1rgUa_tJn3wzqdbN9qoinPTUma&wd=&eqid=cbfd0ef0000f38620000000356c97869
